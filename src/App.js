				...
				<section className='resume-section' id='interests'>
					<div className='resume-section-content'>
						...
						<p>
							...
							skier and novice ice climber. During the warmer
						...
						<p className='mb-0'>
							...
							time exploring the latest technology advancements in
				...
				<section className='resume-section' id='awards'>
					<div className='resume-section-content'>
						...
						<ul className='fa-ul mb-0'>
							<li>
								<span className='fa-li'>
									<i className='fa fa-trophy fa-lg text-warning'></i>
								</span>
							...
							<li>
								...
								1<sup>st</sup>
								Place - James Buchanan High School - Hackathon
								2006
							</li>
							<li>
								<span className='fa-li'>
